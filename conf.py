...
project = u'EnOS Application Portal'
...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS 身份与权限管理} }{\href{https://www.envisioniot.com}{\tiny Envision digital}}}
    ...
    'maketitle': r'''
        ...
        \begin{titlepage}
            ...
            \fontsize{40pt}{\baselineskip}\selectfont \textbf{身份与权限管理}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'Application Portal',
     u'远景智能', 'book', 'true'),
]
...
man_pages = [
    (master_doc, u'enosdocumentationcenter', u'EnOS Application Portal',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS Application Portal',
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS Application Portal',
     author, 'EnOSDocumentationCenter', 'Product documentation about EnOS Application Portal.',
     'Miscellaneous'),
]
